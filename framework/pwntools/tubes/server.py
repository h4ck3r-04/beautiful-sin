...
class server(sock):
    ...
    Arguments:
        ...
        callback: A function to be started on incoming connections. It should take a :class:`pwntools.tubes.remote` as its only argument.
    ...
    def __init__(self, port=0, bindaddr="::", fam="any", typ="tcp",
        ...
        for res in socket.getaddrinfo(
                bindaddr, port, fam, typ, 0, socket.AI_PASSIVE):
        ...
        def accepter():
            while True:
                ...
                h.success(
                    'Got connection from %s on port %d' %
