...
class remote(sock):
    ...
    :class:`pwntools.tubes.sock` and :class:`pwntools.tubes.tube`.
    ...
    Examples:
        ...
        ...
        PwntoolsException: Could not connect to 127.0.0.1 on port 1
    ...
    def __init__(self, host, port,
        ...
        if self.sock:
            ...
            if ssl:
                ...
                ssl_context = ssl_context or _ssl.SSLContext(
    ...
    def fromsocket(cls, socket):
        ...
        Returns:
            Instance of pwntools.tubes.remote.remote.
        """
        s = socket
