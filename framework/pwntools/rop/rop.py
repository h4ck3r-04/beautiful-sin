...
class ROP(object):
  ...
  def setRegisters(self, registers):
    ...
    for gadget in self.gadgets.values():
      ...
      # if both gadgets require same stack space, choose the one with less
      # instructions
      if (old is gadget) \
      ...
      # broken down into pointer-width blobs.
        ...
        if slot.abi.returns:
          ...
          if len(stackArguments) > 0:
            ...
            # We could not find a proper "adjust" gadget, but also didn't need
            # one.
            elif remaining:
