...
pp = project_path
(pp / Path('./pwntools/constants/darwin/aarch64.py')).write_bytes(outbuf1_aarch64.encode())
(pp / Path('./pwntools/data/includes/darwin/aarch64.h')).write_bytes(outbuf2_aarch64.encode())

(pp / Path('./pwntools/constants/darwin/amd64.py')).write_bytes(outbuf1_amd64.encode())
(pp / Path('./pwntools/data/includes/darwin/amd64.h')).write_bytes(outbuf2_amd64.encode())
