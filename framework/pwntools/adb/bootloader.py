...
class BootloaderImage(object):
    def __init__(self, data):
        ...
        self.img_info = imgarray.from_buffer_copy(
            data, ctypes.sizeof(self.header))
    ...
    def extract(self, index_or_name):
        ...
        if index >= len(self.img_info):
            raise ValueError("index out of range (%s, max %s)" %
                             (index, len(self.img_info)))
