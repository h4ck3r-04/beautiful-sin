...
__NR_sched_get_priority_max = Constant(
    '__NR_sched_get_priority_max', (4000 + 163))
__NR_sched_get_priority_min = Constant(
    '__NR_sched_get_priority_min', (4000 + 164))
__NR_sched_rr_get_interval = Constant(
...
__NR_clock_nanosleep_time64 = Constant(
    '__NR_clock_nanosleep_time64', (4000 + 407))
...
__NR_mq_timedreceive_time64 = Constant(
    '__NR_mq_timedreceive_time64', (4000 + 419))
__NR_semtimedop_time64 = Constant('__NR_semtimedop_time64', (4000 + 420))
__NR_rt_sigtimedwait_time64 = Constant(
    '__NR_rt_sigtimedwait_time64', (4000 + 421))
__NR_futex_time64 = Constant('__NR_futex_time64', (4000 + 422))
__NR_sched_rr_get_interval_time64 = Constant(
    '__NR_sched_rr_get_interval_time64', (4000 + 423))
...
SYS_clock_nanosleep_time64 = Constant(
    'SYS_clock_nanosleep_time64', (4000 + 407))
...
SYS_mq_timedreceive_time64 = Constant(
    'SYS_mq_timedreceive_time64', (4000 + 419))
...
SYS_rt_sigtimedwait_time64 = Constant(
    'SYS_rt_sigtimedwait_time64', (4000 + 421))
...
SYS_sched_rr_get_interval_time64 = Constant(
    'SYS_sched_rr_get_interval_time64', (4000 + 423))
