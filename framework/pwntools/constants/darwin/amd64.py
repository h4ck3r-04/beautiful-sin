...
VOL_CAP_FMT_PERSISTENTOBJECTIDS = Constant(
...
VOL_CAP_FMT_CASE_PRESERVING = Constant(
...
VOL_CAP_FMT_NO_VOLUME_SIZES = Constant(
    'VOL_CAP_FMT_NO_VOLUME_SIZES', 0x00008000)
VOL_CAP_FMT_DECMPFS_COMPRESSION = Constant(
    'VOL_CAP_FMT_DECMPFS_COMPRESSION', 0x00010000)
VOL_CAP_FMT_64BIT_OBJECT_IDS = Constant(
...
VOL_CAP_FMT_WRITE_GENERATION_COUNT = Constant(
    'VOL_CAP_FMT_WRITE_GENERATION_COUNT', 0x00100000)
VOL_CAP_FMT_NO_IMMUTABLE_FILES = Constant(
...
VOL_CAP_INT_EXTENDED_SECURITY = Constant(
...
VOL_CAP_INT_RENAME_OPENFAIL = Constant(
...
ATTR_CMN_DATA_PROTECT_FLAGS = Constant(
...
ATTR_CMNEXT_RECURSIVE_GENCOUNT = Constant(
    'ATTR_CMNEXT_RECURSIVE_GENCOUNT', 0x00000400)
ATTR_CMNEXT_ATTRIBUTION_TAG = Constant(
    'ATTR_CMNEXT_ATTRIBUTION_TAG', 0x00000800)
...
VNODE_REMOVE_SKIP_NAMESPACE_EVENT = Constant(
...
IOCS_BUFFER_NUM_COMPRESSION_BUCKETS = Constant(
...
IOCS_SYSCTL_STORE_BUFFER_RD_ONLY = Constant(
    'IOCS_SYSCTL_STORE_BUFFER_RD_ONLY', 0x00000002)
IOCS_SYSCTL_STORE_BUFFER_MARK = Constant(
...
NOTE_VM_PRESSURE_SUDDEN_TERMINATE = Constant(
...
IMGPF_PLUGIN_HOST_DISABLE_A_KEYS = Constant(
...
POSIX_SPAWN_PCONTROL_THROTTLE = Constant(
    'POSIX_SPAWN_PCONTROL_THROTTLE', 0x0001)
...
POSIX_SPAWN_PANIC_ON_NON_ZERO_EXIT = Constant(
    'POSIX_SPAWN_PANIC_ON_NON_ZERO_EXIT', 0x2)
POSIX_SPAWN_PANIC_ON_EXIT = Constant('POSIX_SPAWN_PANIC_ON_EXIT', 0x4)
POSIX_SPAWN_PANIC_ON_SPAWN_FAIL = Constant(
    'POSIX_SPAWN_PANIC_ON_SPAWN_FAIL', 0x8)
...
MAP_TRANSLATED_ALLOW_EXECUTE = Constant(
...
DK_SYNCHRONIZE_OPTION_BARRIER = Constant(
    'DK_SYNCHRONIZE_OPTION_BARRIER', 0x00000002)
DK_CORESTORAGE_PIN_YOUR_METADATA = Constant(
    'DK_CORESTORAGE_PIN_YOUR_METADATA', 0x00000001)
DK_CORESTORAGE_ENABLE_HOTFILES = Constant(
    'DK_CORESTORAGE_ENABLE_HOTFILES', 0x00000002)
DK_CORESTORAGE_PIN_YOUR_SWAPFILE = Constant(
...
DK_FEATURE_FORCE_UNIT_ACCESS = Constant(
...
MACH_AMP_RECOMMENDATION_CHANGE = Constant(
    'MACH_AMP_RECOMMENDATION_CHANGE', 0x3a)
MACH_AMP_PERFCTL_POLICY_CHANGE = Constant(
    'MACH_AMP_PERFCTL_POLICY_CHANGE', 0x3b)
...
MACH_MODE_DEMOTE_RT_DISALLOWED = Constant(
    'MACH_MODE_DEMOTE_RT_DISALLOWED', 0x5b)
...
MACH_MODE_UNDEMOTE_RT_DISALLOWED = Constant(
    'MACH_MODE_UNDEMOTE_RT_DISALLOWED', 0x5e)
MACH_INT_MASKED_RESET = Constant('MACH_INT_MASKED_RESET', 0x5f)
MACH_RT_DISALLOWED_WORK_INTERVAL = Constant(
    'MACH_RT_DISALLOWED_WORK_INTERVAL', 0x60)
...
MACH_SCHED_PREEMPT_TIMER_ACTIVE = Constant(
    'MACH_SCHED_PREEMPT_TIMER_ACTIVE', 0x63)
MACH_SCHED_CLUTCH_ROOT_BUCKET_STATE = Constant(
    'MACH_SCHED_CLUTCH_ROOT_BUCKET_STATE', 0x0)
MACH_SCHED_CLUTCH_TG_BUCKET_STATE = Constant(
    'MACH_SCHED_CLUTCH_TG_BUCKET_STATE', 0x1)
MACH_SCHED_CLUTCH_THREAD_SELECT = Constant(
    'MACH_SCHED_CLUTCH_THREAD_SELECT', 0x2)
MACH_SCHED_CLUTCH_THREAD_STATE = Constant(
    'MACH_SCHED_CLUTCH_THREAD_STATE', 0x3)
MACH_SCHED_CLUTCH_TG_BUCKET_PRI = Constant(
    'MACH_SCHED_CLUTCH_TG_BUCKET_PRI', 0x4)
MACH_SCHED_EDGE_CLUSTER_OVERLOAD = Constant(
    'MACH_SCHED_EDGE_CLUSTER_OVERLOAD', 0x5)
MACH_SCHED_EDGE_STEAL = Constant('MACH_SCHED_EDGE_STEAL', 0x6)
MACH_SCHED_EDGE_REBAL_RUNNABLE = Constant(
    'MACH_SCHED_EDGE_REBAL_RUNNABLE', 0x7)
...
MACH_SCHED_EDGE_CLUSTER_SHARED_LOAD = Constant(
    'MACH_SCHED_EDGE_CLUSTER_SHARED_LOAD', 0xc)
MACH_SCHED_EDGE_RSRC_HEAVY_THREAD = Constant(
    'MACH_SCHED_EDGE_RSRC_HEAVY_THREAD', 0xd)
MACH_SCHED_EDGE_SHARED_RSRC_MIGRATE = Constant(
    'MACH_SCHED_EDGE_SHARED_RSRC_MIGRATE', 0xe)
...
WORKGROUP_INTERVAL_SET_WORKLOAD_ID = Constant(
    'WORKGROUP_INTERVAL_SET_WORKLOAD_ID', 0x6)
WORKGROUP_INTERVAL_SET_WORKLOAD_ID_NAME = Constant(
    'WORKGROUP_INTERVAL_SET_WORKLOAD_ID_NAME', 0x7)
...
MACH_IPC_MSG_RECV_VOUCHER_REFUSED = Constant(
    'MACH_IPC_MSG_RECV_VOUCHER_REFUSED', 0x5)
MACH_IPC_KMSG_FREE = Constant('MACH_IPC_KMSG_FREE', 0x6)
MACH_IPC_VOUCHER_CREATE = Constant('MACH_IPC_VOUCHER_CREATE', 0x7)
MACH_IPC_VOUCHER_CREATE_ATTR_DATA = Constant(
    'MACH_IPC_VOUCHER_CREATE_ATTR_DATA', 0x8)
...
MACH_THREAD_GROUP_PREADOPT_NEXTTIME = Constant(
    'MACH_THREAD_GROUP_PREADOPT_NEXTTIME', 0x8)
MACH_THREAD_GROUP_PREADOPT_CLEAR = Constant(
    'MACH_THREAD_GROUP_PREADOPT_CLEAR', 0x9)
...
MACH_COALITION_THREAD_GROUP_SET = Constant(
...
RMON_DISABLE_CPUUSAGE_MONITOR = Constant(
...
RMON_DISABLE_CPUWAKES_MONITOR = Constant(
...
HV_X86_VM_ADDRSPACE_CREATE_TRAP = Constant(
    'HV_X86_VM_ADDRSPACE_CREATE_TRAP', 0x27)
HV_X86_VM_ADDRSPACE_DESTROY_TRAP = Constant(
    'HV_X86_VM_ADDRSPACE_DESTROY_TRAP', 0x28)
...
IMP_TASK_POLICY_DARWIN_BG_IOPOL = Constant(
...
IMP_TASK_POLICY_NEW_SOCKETS_BG = Constant(
...
IMP_TASK_POLICY_ALL_SOCKETS_BG = Constant(
    'IMP_TASK_POLICY_ALL_SOCKETS_BG', 0x37)
IMP_TASK_POLICY_BASE_LATENCY_AND_THROUGHPUT_QOS = Constant(
    'IMP_TASK_POLICY_BASE_LATENCY_AND_THROUGHPUT_QOS', 0x39)
IMP_TASK_POLICY_OVERRIDE_LATENCY_AND_THROUGHPUT_QOS = Constant(
    'IMP_TASK_POLICY_OVERRIDE_LATENCY_AND_THROUGHPUT_QOS', 0x3A)
...
IMP_TASK_POLICY_QOS_AND_RELPRIO = Constant(
    'IMP_TASK_POLICY_QOS_AND_RELPRIO', 0x38)
IMP_TASK_POLICY_QOS_WORKQ_OVERRIDE = Constant(
    'IMP_TASK_POLICY_QOS_WORKQ_OVERRIDE', 0x3B)
IMP_TASK_POLICY_QOS_PROMOTE = Constant('IMP_TASK_POLICY_QOS_PROMOTE', 0x3C)
IMP_TASK_POLICY_QOS_KEVENT_OVERRIDE = Constant(
    'IMP_TASK_POLICY_QOS_KEVENT_OVERRIDE', 0x3D)
IMP_TASK_POLICY_QOS_SERVICER_OVERRIDE = Constant(
    'IMP_TASK_POLICY_QOS_SERVICER_OVERRIDE', 0x3E)
IMP_TASK_POLICY_IOTIER_KEVENT_OVERRIDE = Constant(
    'IMP_TASK_POLICY_IOTIER_KEVENT_OVERRIDE', 0x3F)
...
IMP_DONOR_UPDATE_LIVE_DONOR_STATE = Constant(
...
THREAD_ADDED_TO_TURNSTILE_WAITQ = Constant(
    'THREAD_ADDED_TO_TURNSTILE_WAITQ', 0x1)
THREAD_REMOVED_FROM_TURNSTILE_WAITQ = Constant(
    'THREAD_REMOVED_FROM_TURNSTILE_WAITQ', 0x2)
THREAD_MOVED_IN_TURNSTILE_WAITQ = Constant(
    'THREAD_MOVED_IN_TURNSTILE_WAITQ', 0x3)
TURNSTILE_ADDED_TO_TURNSTILE_HEAP = Constant(
    'TURNSTILE_ADDED_TO_TURNSTILE_HEAP', 0x4)
TURNSTILE_REMOVED_FROM_TURNSTILE_HEAP = Constant(
    'TURNSTILE_REMOVED_FROM_TURNSTILE_HEAP', 0x5)
TURNSTILE_MOVED_IN_TURNSTILE_HEAP = Constant(
    'TURNSTILE_MOVED_IN_TURNSTILE_HEAP', 0x6)
TURNSTILE_ADDED_TO_THREAD_HEAP = Constant(
    'TURNSTILE_ADDED_TO_THREAD_HEAP', 0x7)
TURNSTILE_REMOVED_FROM_THREAD_HEAP = Constant(
    'TURNSTILE_REMOVED_FROM_THREAD_HEAP', 0x8)
TURNSTILE_MOVED_IN_THREAD_HEAP = Constant(
    'TURNSTILE_MOVED_IN_THREAD_HEAP', 0x9)
TURNSTILE_UPDATE_STOPPED_BY_LIMIT = Constant(
    'TURNSTILE_UPDATE_STOPPED_BY_LIMIT', 0xa)
THREAD_NOT_WAITING_ON_TURNSTILE = Constant(
...
BANK_SECURE_ORIGINATOR_CHANGED = Constant(
    'BANK_SECURE_ORIGINATOR_CHANGED', 0x2)
...
IOPOL_TYPE_VFS_MATERIALIZE_DATALESS_FILES = Constant(
    'IOPOL_TYPE_VFS_MATERIALIZE_DATALESS_FILES', 3)
IOPOL_TYPE_VFS_STATFS_NO_DATA_VOLUME = Constant(
    'IOPOL_TYPE_VFS_STATFS_NO_DATA_VOLUME', 4)
IOPOL_TYPE_VFS_TRIGGER_RESOLVE = Constant('IOPOL_TYPE_VFS_TRIGGER_RESOLVE', 5)
IOPOL_TYPE_VFS_IGNORE_CONTENT_PROTECTION = Constant(
    'IOPOL_TYPE_VFS_IGNORE_CONTENT_PROTECTION', 6)
IOPOL_TYPE_VFS_IGNORE_PERMISSIONS = Constant(
    'IOPOL_TYPE_VFS_IGNORE_PERMISSIONS', 7)
IOPOL_TYPE_VFS_SKIP_MTIME_UPDATE = Constant(
    'IOPOL_TYPE_VFS_SKIP_MTIME_UPDATE', 8)
IOPOL_TYPE_VFS_ALLOW_LOW_SPACE_WRITES = Constant(
    'IOPOL_TYPE_VFS_ALLOW_LOW_SPACE_WRITES', 9)
IOPOL_TYPE_VFS_DISALLOW_RW_FOR_O_EVTONLY = Constant(
...
IOPOL_MATERIALIZE_DATALESS_FILES_DEFAULT = Constant(
    'IOPOL_MATERIALIZE_DATALESS_FILES_DEFAULT', 0)
IOPOL_MATERIALIZE_DATALESS_FILES_OFF = Constant(
    'IOPOL_MATERIALIZE_DATALESS_FILES_OFF', 1)
IOPOL_MATERIALIZE_DATALESS_FILES_ON = Constant(
    'IOPOL_MATERIALIZE_DATALESS_FILES_ON', 2)
IOPOL_VFS_STATFS_NO_DATA_VOLUME_DEFAULT = Constant(
    'IOPOL_VFS_STATFS_NO_DATA_VOLUME_DEFAULT', 0)
IOPOL_VFS_STATFS_FORCE_NO_DATA_VOLUME = Constant(
    'IOPOL_VFS_STATFS_FORCE_NO_DATA_VOLUME', 1)
IOPOL_VFS_TRIGGER_RESOLVE_DEFAULT = Constant(
    'IOPOL_VFS_TRIGGER_RESOLVE_DEFAULT', 0)
IOPOL_VFS_TRIGGER_RESOLVE_OFF = Constant('IOPOL_VFS_TRIGGER_RESOLVE_OFF', 1)
IOPOL_VFS_CONTENT_PROTECTION_DEFAULT = Constant(
    'IOPOL_VFS_CONTENT_PROTECTION_DEFAULT', 0)
IOPOL_VFS_CONTENT_PROTECTION_IGNORE = Constant(
    'IOPOL_VFS_CONTENT_PROTECTION_IGNORE', 1)
IOPOL_VFS_IGNORE_PERMISSIONS_OFF = Constant(
    'IOPOL_VFS_IGNORE_PERMISSIONS_OFF', 0)
IOPOL_VFS_IGNORE_PERMISSIONS_ON = Constant(
    'IOPOL_VFS_IGNORE_PERMISSIONS_ON', 1)
IOPOL_VFS_SKIP_MTIME_UPDATE_OFF = Constant(
    'IOPOL_VFS_SKIP_MTIME_UPDATE_OFF', 0)
IOPOL_VFS_SKIP_MTIME_UPDATE_ON = Constant('IOPOL_VFS_SKIP_MTIME_UPDATE_ON', 1)
IOPOL_VFS_ALLOW_LOW_SPACE_WRITES_OFF = Constant(
    'IOPOL_VFS_ALLOW_LOW_SPACE_WRITES_OFF', 0)
IOPOL_VFS_ALLOW_LOW_SPACE_WRITES_ON = Constant(
    'IOPOL_VFS_ALLOW_LOW_SPACE_WRITES_ON', 1)
IOPOL_VFS_DISALLOW_RW_FOR_O_EVTONLY_DEFAULT = Constant(
    'IOPOL_VFS_DISALLOW_RW_FOR_O_EVTONLY_DEFAULT', 0)
IOPOL_VFS_DISALLOW_RW_FOR_O_EVTONLY_ON = Constant(
    'IOPOL_VFS_DISALLOW_RW_FOR_O_EVTONLY_ON', 1)
IOPOL_VFS_NOCACHE_WRITE_FS_BLKSIZE_DEFAULT = Constant(
    'IOPOL_VFS_NOCACHE_WRITE_FS_BLKSIZE_DEFAULT', 0)
IOPOL_VFS_NOCACHE_WRITE_FS_BLKSIZE_ON = Constant(
...
VFS_IOATTR_FLAGS_SWAPPIN_SUPPORTED = Constant(
...
VFS_TBLVNOP_NOUPDATEID_RENAME = Constant(
...
VFSIOC_MOUNT_BYROLE_has_recovery = Constant(
...
KDEBUG_COMMPAGE_ENABLE_TYPEFILTER = Constant(
    'KDEBUG_COMMPAGE_ENABLE_TYPEFILTER', 0x2)
...
SYS_openat_dprotected_np = Constant(
    'SYS_openat_dprotected_np', 218 + 0x2000000)
...
SYS_shared_region_check_np = Constant(
    'SYS_shared_region_check_np', 294 + 0x2000000)
SYS_vm_pressure_monitor = Constant('SYS_vm_pressure_monitor', 296 + 0x2000000)
SYS_psynch_rw_longrdlock = Constant(
    'SYS_psynch_rw_longrdlock', 297 + 0x2000000)
SYS_psynch_rw_yieldwrlock = Constant(
    'SYS_psynch_rw_yieldwrlock', 298 + 0x2000000)
...
SYS___disable_threadsignal = Constant(
    'SYS___disable_threadsignal', 331 + 0x2000000)
SYS___pthread_markcancel = Constant(
    'SYS___pthread_markcancel', 332 + 0x2000000)
...
SYS_aio_suspend_nocancel = Constant(
    'SYS_aio_suspend_nocancel', 421 + 0x2000000)
SYS___sigwait_nocancel = Constant('SYS___sigwait_nocancel', 422 + 0x2000000)
SYS___semwait_signal_nocancel = Constant(
    'SYS___semwait_signal_nocancel', 423 + 0x2000000)
...
SYS_pid_shutdown_sockets = Constant(
    'SYS_pid_shutdown_sockets', 436 + 0x2000000)
SYS_kas_info = Constant('SYS_kas_info', 439 + 0x2000000)
SYS_memorystatus_control = Constant(
    'SYS_memorystatus_control', 440 + 0x2000000)
...
SYS_memorystatus_get_level = Constant(
    'SYS_memorystatus_get_level', 453 + 0x2000000)
...
SYS_guarded_open_dprotected_np = Constant(
    'SYS_guarded_open_dprotected_np', 484 + 0x2000000)
...
SYS_stack_snapshot_with_config = Constant(
    'SYS_stack_snapshot_with_config', 491 + 0x2000000)
...
SYS_mach_eventlink_signal = Constant(
    'SYS_mach_eventlink_signal', 496 + 0x2000000)
SYS_mach_eventlink_wait_until = Constant(
    'SYS_mach_eventlink_wait_until', 497 + 0x2000000)
SYS_mach_eventlink_signal_wait_until = Constant(
    'SYS_mach_eventlink_signal_wait_until', 498 + 0x2000000)
...
SYS_register_uexc_handler = Constant(
    'SYS_register_uexc_handler', 519 + 0x2000000)
SYS_terminate_with_payload = Constant(
    'SYS_terminate_with_payload', 520 + 0x2000000)
...
SYS_os_fault_with_payload = Constant(
    'SYS_os_fault_with_payload', 529 + 0x2000000)
SYS_kqueue_workloop_ctl = Constant('SYS_kqueue_workloop_ctl', 530 + 0x2000000)
SYS___mach_bridge_remote_time = Constant(
    'SYS___mach_bridge_remote_time', 531 + 0x2000000)
SYS_coalition_ledger = Constant('SYS_coalition_ledger', 532 + 0x2000000)
SYS_log_data = Constant('SYS_log_data', 533 + 0x2000000)
SYS_memorystatus_available_memory = Constant(
    'SYS_memorystatus_available_memory', 534 + 0x2000000)
SYS_objc_bp_assist_cfg_np = Constant(
    'SYS_objc_bp_assist_cfg_np', 535 + 0x2000000)
SYS_shared_region_map_and_slide_2_np = Constant(
    'SYS_shared_region_map_and_slide_2_np', 536 + 0x2000000)
SYS_pivot_root = Constant('SYS_pivot_root', 537 + 0x2000000)
SYS_task_inspect_for_pid = Constant(
    'SYS_task_inspect_for_pid', 538 + 0x2000000)
...
SYS_proc_info_extended_id = Constant(
    'SYS_proc_info_extended_id', 545 + 0x2000000)
SYS_tracker_action = Constant('SYS_tracker_action', 546 + 0x2000000)
SYS_debug_syscall_reject = Constant(
    'SYS_debug_syscall_reject', 547 + 0x2000000)
SYS_debug_syscall_reject_config = Constant(
    'SYS_debug_syscall_reject_config', 548 + 0x2000000)
...
SYS_MAXSYSCALL = Constant('SYS_MAXSYSCALL', 556 + 0x2000000)
...
SO_TRACKER_ATTRIBUTE_FLAGS_APP_APPROVED = Constant(
    'SO_TRACKER_ATTRIBUTE_FLAGS_APP_APPROVED', 0x00000001)
SO_TRACKER_ATTRIBUTE_FLAGS_TRACKER = Constant(
    'SO_TRACKER_ATTRIBUTE_FLAGS_TRACKER', 0x00000002)
SO_TRACKER_ATTRIBUTE_FLAGS_DOMAIN_SHORT = Constant(
