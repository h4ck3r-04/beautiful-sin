...
from pwntools.shellcraft import internal
...
class module(ModuleType):
    ...
    def __lazyinit__(self):
        ...
        self.__all__ = sorted(
            itertools.chain(
                self._shellcodes.keys(),
                self._submodules.keys()))
    ...
    def __getattr__(self, key):
        ...
        if key in self._shellcodes:
            real = internal.make_function(
                key, self._shellcodes[key], self._dir)
    ...
    from pwntools.shellcraft import registers
